             ...
             for user_data in db.user.find({}):
               ...
               if True:
                ...
                try:
                    ...
                    log("Fail********Qurora didnt load User ip" + ip_data + " user details:" + user_data['email'] + 'upvote profile:' +
                        profile_data['profile_link'])
                    continue
                # control.signal(Signal.NEWNYM)
                # time.sleep(control.get_newnym_wait())
                ...
                try:
                 ...
                 element = WebDriverWait(driver, 15).until(EC.presence_of_element_located((By.CLASS_NAME, "PagedListFoo")))
                except TimeoutException as ex:
                    print "timeout"
                ...
                try:
                    ...
                    try:
                        ...
                        log("FAIL:*****loading profile"+"User ip" + ip_data + " user details:" + user_data['email'] + 'upvote profile:' +
                            profile_data['profile_link'])
                        print "time out"
                        continue
